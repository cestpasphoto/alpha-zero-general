...
def main():
	...
	parser.add_argument('--temperature'     , '-t' , action='store', default=[1., 1., 1.], type=float, nargs=3, help='Softmax temp: 1 = to apply before MCTS, 2 = after MCTS + used for learning/selection, 3 = only used for selection')
