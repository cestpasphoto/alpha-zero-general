...
from smallworld.NNet import NNetWrapper as nn
from utils import *
import subprocess
...
def main():
	...
	parser.add_argument('--universes'       , '-u' , action='store', default=0    , type=int  , help='Number of universes to test on each full simulation')
